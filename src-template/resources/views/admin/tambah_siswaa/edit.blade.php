...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.tambah_siswaa.update", [$tambah_siswa->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            {{-- <div class="form-group">
                <label for="image">{{ trans('cruds.tambah_siswaa.fields.image') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.tambah_siswaa.fields.image_helper') }}</span>
            </div> --}}
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('jenis_kelamin') ? 'is-invalid' : '' }}" name="jenis_kelamin" id="jenis_kelamin">
                    ...
                    @foreach(App\Models\tambah_siswaa::jenis_kelamin as $key => $label)
