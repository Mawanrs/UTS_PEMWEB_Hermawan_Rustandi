...
<div class="card">
    ...
    <div class="card-body">
        <div class="form-group">
            <div class="form-group">
                <a class="btn btn-default" href="{{ route('admin.tambah_siswaas.index') }}">
            ...
            <table class="table table-bordered table-striped">
                <tbody>
                    ...
                    <tr>
                        {{-- <th>
                            {{ trans('cruds.tambah_siswaa.fields.image') }}
                        </th> --}}
                        {{-- <td>
                            @if($tambah_siswaa->image)
                                <a href="{{ $tambah_siswaa->image->getUrl() }}" target="_blank" style="display: inline-block">
                                    <img src="{{ $tambah_siswaa->image->getUrl('thumb') }}">
                                </a>
                            @endif
                        </td> --}}
                    </tr>
